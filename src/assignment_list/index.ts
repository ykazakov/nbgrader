...
export class AssignmentListWidget extends Widget {
  ...
  constructor(app: JupyterFrontEnd) {
    ...
    var assignment_html = ([
      ...
      '      </div>',
      '      <div class="panel-body">',
      '        <div id="released_solutions_list" class="list_container">',
      '          <div id="released_solutions_list_placeholder" class="list_placeholder">',
      '            <div> There are no solutions to fetch. </div>',
      '          </div>',
      '          <div id="released_solutions_list_loading" class="list_loading">',
      '            <div> Loading, please wait... </div>',
      '          </div>',
      '          <div id="released_solutions_list_error" class="list_error">',
      '            <div></div>',
      '          </div>',
      '        </div>',
      '      </div>',
      ...
      '      </div>',
      '      <div class="panel-body">',
      '        <div id="fetched_solutions_list" class="list_container" role="tablist" aria-multiselectable="true">',
      '          <div id="fetched_solutions_list_placeholder" class="list_placeholder">',
      '            <div> There are no downloaded solutions. </div>',
      '          </div>',
      '          <div id="fetched_solutions_list_loading" class="list_loading">',
      '            <div> Loading, please wait... </div>',
      '          </div>',
      '          <div id="fetched_solutions_list_error" class="list_error">',
      '            <div></div>',
      '          </div>',
      '        </div>',
      '      </div>',
    ...
    var assignment_l = new AssignmentList(this,
      ...
      'released_solutions_list',
      'fetched_solutions_list',
      options,
      this.app);
